#policy
resource "azurerm_policy_definition" "PCD-DeployDiagnosticsWebServerFarm" {
  name         = "PCD-DeployDiagnosticsWebServerFarm"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "PCD-DeployDiagnosticsWebServerFarm"
